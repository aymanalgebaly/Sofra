...
public class UserDetailsOfferAdapter extends RecyclerView.Adapter<UserDetailsOfferAdapter.ViewHolderDetails> {

    private Context context;
    private List<ItemFoodData> itemFoodDataList;

    public UserDetailsOfferAdapter(List<ItemFoodData> itemFoodDataList) {
        this.itemFoodDataList = itemFoodDataList;
    }

    public UserDetailsOfferAdapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public ViewHolderDetails onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ViewHolderDetails holder, int i) {
    ...
    public void setUserDetailsAdapter(List<ItemFoodData> foodDataList) {
        this.itemFoodDataList = foodDataList;
    }
