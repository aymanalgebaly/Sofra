...
public class UserFoodListAdapter extends RecyclerView.Adapter<UserFoodListAdapter.foodListViewHolder> {


    private final Context context;
    private List<ItemFoodData> itemFoodDataList;
    public ItemFoodData itemFoodData_new;
    onItemClickListner onItemClickListener;

    public UserFoodListAdapter(Context context) {
    ...
    public void setOnItemClickListner(UserFoodListAdapter.onItemClickListner onItemClickListner) {
